...
use app\common\controller\Shop as ShopController;
...
class Administrator extends ShopController
{
    ...
    public function information()
    {
        ...
        $shopInfo = $shopModel->where(['id'=>$this->shopId])->find();
    ...
    public function editPwd()
    {
        ...
        return $shopModel->chengePwd($this->shopId, input('param.password'), input('param.newPwd'));
    }
