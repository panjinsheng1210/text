...
class Index extends Manage
{
    ...
    public function index(){
        ...
        $this->assign('image',_sImage(''));
        $this->assign('iconfont',config('params.iconfont'));
...
//        $unship_count = $orderModel->where(['status'=>1,'pay_status'=>2,'ship_status'=>1])->count();
        ...
        $count = $orderModel->getOrderStatusNum(['ids' => '1,2']);
        $unpaid_count = $count[1];
        $unship_count = $count[2];
        //待售后数量
