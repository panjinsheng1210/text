        ...
        try{
            ...
            if(isset($orderInfo) && !empty($orderInfo)){
                foreach ($orderInfo as $key=>$val){
                    $addShop      = $val['goods_amount'] * $ratio['shopRatio'][$val['shop_type']];
                    ...
                    $addPoint += $val['goods_amount'] * $ratio['pointRatio'][$val['shop_type']] * $ratio['pointRatio']['public'];
                }
            }
            // 消费者添加积分明细
